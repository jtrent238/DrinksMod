package com.jtrent238.drinks.items.money;
...
{
	public static final String[] field_150923_a = new String[] {"cash_1"};
    public static final String[] field_150921_b = new String[] {"cash_1"};
    ...
    public void getSubItems(Item p_150895_1_, CreativeTabs p_150895_2_, List p_150895_3_)
    {
        ...
        for (int i = 0; i < Main.moneycount; ++i)
        {
